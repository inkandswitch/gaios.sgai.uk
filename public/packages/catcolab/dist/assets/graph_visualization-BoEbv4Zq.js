const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./main-CMcyqiqU.js","./analysis_tool-dmxyNWB4.js","./model-hspTLkzk.js","./index--5ogabjI.js","./export_svg-DhqrBrZu.js","./file-download-Ckmh08Om.js"])))=>i.map(i=>d[i]);
...
import { o as invariant, y as access, q as IconButton } from './analysis_tool-dmxyNWB4.js';
import './pde_plot-DqYMTLO6.js';
import { d as download_default } from './download-B-pVQE6W.js';
...
async function loadElk() {
  const ELK = (await __vitePreload(async () => { const {default: __vite_default__} = await import('./main-CMcyqiqU.js').then(n => n.m);return { default: __vite_default__ }},true?__vite__mapDeps([0,1,2,3]):undefined,import.meta.url)).default;
  return new ELK();
}
  ...
  const download = async () => {
    if (props.svg) {
      const {
        ...
        downloadSVG
      } = await import('./export_svg-DhqrBrZu.js');return {
        downloadSVG
