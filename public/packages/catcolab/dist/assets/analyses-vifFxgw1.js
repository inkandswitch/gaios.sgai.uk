const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./decapodes-BD5sZ6q5.js","./analysis_tool-Bl31dlnB.js","./model-hspTLkzk.js","./index-CpJyZPkM.js","./rotate-ccw-DAXWuwkp.js","./alert-5Xh6KlyY.js","./block_title-BmY95pGr.js","./foldable-B595KXEW.js","./pde_plot-BqBKBDFR.js","./diagram_graph-unUzQSja.js","./graph_visualization-CumGIAye.js","./graph_visualization-jOxgsuAb.js","./download-DQHL-c2Z.js","./graphviz-ClZ6RL4J.js","./text_styles.module-DnOSZP5l.js","./tabular_view-cUpX6CNa.js","./panel-CdwhxX9I.js","./kuramoto-BsBRv3jn.js","./label-GvQ4fTcU.js","./model_ode_plot-LLQrAki8.js","./linear_ode-GARkJ4Np.js","./lotka_volterra-mWP8EPqe.js","./mass_action-DH6-Ph_p.js","./katex_display-2b30UEya.js","./mass_action_config_form-CCV4sDzc.js","./mass_action_equations-7cIoZLO3.js","./stochastic_mass_action-C6fFBjNG.js","./model_graph-Dh0yz9PY.js","./schema_erd-D2kOvfDB.js","./file-download-CkoOu1s2.js","./submodel_graphs-DVbkwoaO.js","./petri_net_visualization-BcOTH81K.js","./svg_styles.module-CorR5PWz.js","./reachability-D9ST0GcS.js","./stock_flow_diagram-rV4s7e7X.js","./sql-CyqnWd_K.js","./polynomial_ode_equations-By9GLmxA.js","./polynomial_ode_simulation-CBZgtyYI.js"])))=>i.map(i=>d[i]);
...
const Decapodes = lazy(() => __vitePreload(() => import('./decapodes-BD5sZ6q5.js'),true?__vite__mapDeps([0,1,2,3,4,5,6,7,8]):undefined,import.meta.url));
...
const DiagramGraph = lazy(() => __vitePreload(() => import('./diagram_graph-unUzQSja.js'),true?__vite__mapDeps([9,10,1,2,3,6,8,5,11,12,13,14]):undefined,import.meta.url));
...
const TabularView = lazy(() => __vitePreload(() => import('./tabular_view-cUpX6CNa.js'),true?__vite__mapDeps([15,1,2,3,16]):undefined,import.meta.url));
...
const Kuramoto = lazy(() => __vitePreload(() => import('./kuramoto-BsBRv3jn.js'),true?__vite__mapDeps([17,1,2,3,6,7,18,8,5,19]):undefined,import.meta.url));
...
const LinearODE = lazy(() => __vitePreload(() => import('./linear_ode-GARkJ4Np.js'),true?__vite__mapDeps([20,1,2,3,6,7,18,8,5,19]):undefined,import.meta.url));
...
const LotkaVolterra = lazy(() => __vitePreload(() => import('./lotka_volterra-mWP8EPqe.js'),true?__vite__mapDeps([21,1,2,3,6,7,18,8,5,19]):undefined,import.meta.url));
...
const MassAction = lazy(() => __vitePreload(() => import('./mass_action-DH6-Ph_p.js'),true?__vite__mapDeps([22,1,2,3,6,7,23,18,8,5,24,19]):undefined,import.meta.url));
...
const MassActionEquationsDisplay = lazy(() => __vitePreload(() => import('./mass_action_equations-7cIoZLO3.js'),true?__vite__mapDeps([25,1,2,3,6,23,24,19]):undefined,import.meta.url));
...
const StochasticMassAction = lazy(() => __vitePreload(() => import('./stochastic_mass_action-C6fFBjNG.js'),true?__vite__mapDeps([26,4,1,2,3,6,7,18,8,5,19]):undefined,import.meta.url));
...
const ModelGraph = lazy(() => __vitePreload(() => import('./model_graph-Dh0yz9PY.js'),true?__vite__mapDeps([27,10,1,2,3,6,8,5,11,12,13,14]):undefined,import.meta.url));
const schemaERD = (options) => ({
  ...options,
  component: (props) => createComponent(SchemaERD, props),
  initialContent: defaultSchemaERDConfig
});
const SchemaERD = lazy(() => __vitePreload(() => import('./schema_erd-D2kOvfDB.js'),true?__vite__mapDeps([28,29,1,2,3,12,6,8,5,13]):undefined,import.meta.url));
...
const SubmodelGraphs = lazy(() => __vitePreload(() => import('./submodel_graphs-DVbkwoaO.js'),true?__vite__mapDeps([30,1,2,3,6,8,5,13,10,11,12,14,27]):undefined,import.meta.url));
const petriNetVisualization = (options) => ({
  ...options,
  component: PetriNetVisualization,
  initialContent: defaultConfig
});
const PetriNetVisualization = lazy(() => __vitePreload(() => import('./petri_net_visualization-BcOTH81K.js'),true?__vite__mapDeps([31,1,2,3,10,6,8,5,11,12,13,14,32]):undefined,import.meta.url));
...
const Reachability = lazy(() => __vitePreload(() => import('./reachability-D9ST0GcS.js'),true?__vite__mapDeps([33,1,2,3,16]):undefined,import.meta.url));
const stockFlowDiagram = (options) => ({
  ...options,
  component: StockFlowDiagram,
  initialContent: defaultConfig
});
const StockFlowDiagram = lazy(() => __vitePreload(() => import('./stock_flow_diagram-rV4s7e7X.js'),true?__vite__mapDeps([34,1,2,3,11,8,5,12,10,6,13,14,27,32]):undefined,import.meta.url));
...
const SQLSchemaAnalysis = lazy(() => __vitePreload(() => import('./sql-CyqnWd_K.js'),true?__vite__mapDeps([35,29,1,2,3,12,5,6]):undefined,import.meta.url));
...
const PolynomialODEEquationsDisplay = lazy(() => __vitePreload(() => import('./polynomial_ode_equations-By9GLmxA.js'),true?__vite__mapDeps([36,1,2,3,6,23,19]):undefined,import.meta.url));
...
const PolynomialODESimulation = lazy(() => __vitePreload(() => import('./polynomial_ode_simulation-CBZgtyYI.js'),true?__vite__mapDeps([37,1,2,3,6,7,23,8,5,19]):undefined,import.meta.url));
