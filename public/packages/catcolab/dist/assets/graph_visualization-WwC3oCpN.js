const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./main-CS6xtKsD.js","./analysis_tool-CDs3CHfO.js","./model-hspTLkzk.js","./index-BLpRC7wy.js","./export_svg-DVC9Yc1e.js","./file-download-YvO0ab2e.js"])))=>i.map(i=>d[i]);
...
import { o as invariant, y as access, q as IconButton } from './analysis_tool-CDs3CHfO.js';
import './pde_plot-BQ7NHVgB.js';
import { d as download_default } from './download-3KYVIY7d.js';
...
async function loadElk() {
  const ELK = (await __vitePreload(async () => { const {default: __vite_default__} = await import('./main-CS6xtKsD.js').then(n => n.m);return { default: __vite_default__ }},true?__vite__mapDeps([0,1,2,3]):undefined,import.meta.url)).default;
  return new ELK();
}
  ...
  const download = async () => {
    if (props.svg) {
      const {
        ...
        downloadSVG
      } = await import('./export_svg-DVC9Yc1e.js');return {
        downloadSVG
