const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./decapodes-DSmQy13D.js","./analysis_tool-CbAnz5ie.js","./model-hspTLkzk.js","./index-B65VBQSl.js","./rotate-ccw-BeErqM-r.js","./alert-LmUGnZKX.js","./block_title-CkcLyKoo.js","./foldable-Cyvk3uUr.js","./pde_plot-Ddd_bVHz.js","./diagram_graph-7bwSK1KX.js","./graph_visualization-COaDU7cB.js","./graph_visualization-DD1X2a0g.js","./download-FHbQm7GT.js","./graphviz-Dn4HYuzh.js","./text_styles.module-DnOSZP5l.js","./tabular_view-zjxJxZVi.js","./panel-CGOGYpJ-.js","./kuramoto-JjV09b64.js","./label-GvQ4fTcU.js","./model_ode_plot-LLQrAki8.js","./linear_ode-DVkTEg_K.js","./lotka_volterra-8Pnh8u1i.js","./mass_action-Z2A4tnN_.js","./katex_display-BzHbZBTy.js","./mass_action_config_form-NgNZI16X.js","./mass_action_equations-C_D5SPUa.js","./stochastic_mass_action--z6bddXd.js","./model_graph-AMAykTxl.js","./schema_erd-4ShNld_P.js","./file-download-Dcckh3B1.js","./submodel_graphs-CrIIXSF-.js","./petri_net_visualization-CfztUCw-.js","./svg_styles.module-CorR5PWz.js","./reachability-NLVUHXq9.js","./stock_flow_diagram-DZTSGchL.js","./sql-VlwVCy2Q.js","./polynomial_ode_equations-BN_UTn86.js","./polynomial_ode_simulation-f4SgiogP.js"])))=>i.map(i=>d[i]);
...
const Decapodes = lazy(() => __vitePreload(() => import('./decapodes-DSmQy13D.js'),true?__vite__mapDeps([0,1,2,3,4,5,6,7,8]):undefined,import.meta.url));
...
const DiagramGraph = lazy(() => __vitePreload(() => import('./diagram_graph-7bwSK1KX.js'),true?__vite__mapDeps([9,10,1,2,3,6,8,5,11,12,13,14]):undefined,import.meta.url));
...
const TabularView = lazy(() => __vitePreload(() => import('./tabular_view-zjxJxZVi.js'),true?__vite__mapDeps([15,1,2,3,16]):undefined,import.meta.url));
...
const Kuramoto = lazy(() => __vitePreload(() => import('./kuramoto-JjV09b64.js'),true?__vite__mapDeps([17,1,2,3,6,7,18,8,5,19]):undefined,import.meta.url));
...
const LinearODE = lazy(() => __vitePreload(() => import('./linear_ode-DVkTEg_K.js'),true?__vite__mapDeps([20,1,2,3,6,7,18,8,5,19]):undefined,import.meta.url));
...
const LotkaVolterra = lazy(() => __vitePreload(() => import('./lotka_volterra-8Pnh8u1i.js'),true?__vite__mapDeps([21,1,2,3,6,7,18,8,5,19]):undefined,import.meta.url));
...
const MassAction = lazy(() => __vitePreload(() => import('./mass_action-Z2A4tnN_.js'),true?__vite__mapDeps([22,1,2,3,6,7,23,18,8,5,24,19]):undefined,import.meta.url));
...
const MassActionEquationsDisplay = lazy(() => __vitePreload(() => import('./mass_action_equations-C_D5SPUa.js'),true?__vite__mapDeps([25,1,2,3,6,23,24,19]):undefined,import.meta.url));
...
const StochasticMassAction = lazy(() => __vitePreload(() => import('./stochastic_mass_action--z6bddXd.js'),true?__vite__mapDeps([26,4,1,2,3,6,7,18,8,5,19]):undefined,import.meta.url));
...
const ModelGraph = lazy(() => __vitePreload(() => import('./model_graph-AMAykTxl.js'),true?__vite__mapDeps([27,10,1,2,3,6,8,5,11,12,13,14]):undefined,import.meta.url));
const schemaERD = (options) => ({
  ...options,
  component: (props) => createComponent(SchemaERD, props),
  initialContent: defaultSchemaERDConfig
});
const SchemaERD = lazy(() => __vitePreload(() => import('./schema_erd-4ShNld_P.js'),true?__vite__mapDeps([28,29,1,2,3,12,6,8,5,13]):undefined,import.meta.url));
...
const SubmodelGraphs = lazy(() => __vitePreload(() => import('./submodel_graphs-CrIIXSF-.js'),true?__vite__mapDeps([30,1,2,3,6,8,5,13,10,11,12,14,27]):undefined,import.meta.url));
const petriNetVisualization = (options) => ({
  ...options,
  component: PetriNetVisualization,
  initialContent: defaultConfig
});
const PetriNetVisualization = lazy(() => __vitePreload(() => import('./petri_net_visualization-CfztUCw-.js'),true?__vite__mapDeps([31,1,2,3,10,6,8,5,11,12,13,14,32]):undefined,import.meta.url));
...
const Reachability = lazy(() => __vitePreload(() => import('./reachability-NLVUHXq9.js'),true?__vite__mapDeps([33,1,2,3,16]):undefined,import.meta.url));
const stockFlowDiagram = (options) => ({
  ...options,
  component: StockFlowDiagram,
  initialContent: defaultConfig
});
const StockFlowDiagram = lazy(() => __vitePreload(() => import('./stock_flow_diagram-DZTSGchL.js'),true?__vite__mapDeps([34,1,2,3,11,8,5,12,10,6,13,14,27,32]):undefined,import.meta.url));
...
const SQLSchemaAnalysis = lazy(() => __vitePreload(() => import('./sql-VlwVCy2Q.js'),true?__vite__mapDeps([35,29,1,2,3,12,5,6]):undefined,import.meta.url));
...
const PolynomialODEEquationsDisplay = lazy(() => __vitePreload(() => import('./polynomial_ode_equations-BN_UTn86.js'),true?__vite__mapDeps([36,1,2,3,6,23,19]):undefined,import.meta.url));
...
const PolynomialODESimulation = lazy(() => __vitePreload(() => import('./polynomial_ode_simulation-f4SgiogP.js'),true?__vite__mapDeps([37,1,2,3,6,7,23,8,5,19]):undefined,import.meta.url));
