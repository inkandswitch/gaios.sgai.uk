const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./decapodes-TXhFE0e8.js","./analysis_tool-dmxyNWB4.js","./model-hspTLkzk.js","./index--5ogabjI.js","./rotate-ccw-CXck-cMg.js","./alert-D5m2WCDd.js","./block_title-Df1W6z2i.js","./foldable-CyqlIXxi.js","./pde_plot-DqYMTLO6.js","./diagram_graph-CF4tgs2w.js","./graph_visualization-CubHbCQq.js","./graph_visualization-BoEbv4Zq.js","./download-B-pVQE6W.js","./graphviz-Dw4eXT7S.js","./text_styles.module-DnOSZP5l.js","./tabular_view-W0fPiqrE.js","./panel-ycBhceMU.js","./kuramoto-DDe-gt4g.js","./label-GvQ4fTcU.js","./model_ode_plot-LLQrAki8.js","./linear_ode-BQ8pzE74.js","./lotka_volterra-X9LuAZEa.js","./mass_action-C5_72pRF.js","./katex_display-7iUwHJ8a.js","./mass_action_config_form-BjHkEX3a.js","./mass_action_equations-CT7V0OaP.js","./stochastic_mass_action-8nYBsFsu.js","./model_graph-CYxNfIrL.js","./schema_erd-D79g4A5V.js","./file-download-Ckmh08Om.js","./submodel_graphs-CeCtHOgy.js","./petri_net_visualization-DiVOgP45.js","./svg_styles.module-CorR5PWz.js","./reachability-7udr0CoP.js","./stock_flow_diagram-LrwFUjz7.js","./sql-E5VPUVr4.js","./polynomial_ode_equations-DKvcEdmX.js","./polynomial_ode_simulation-BwIZvX8d.js"])))=>i.map(i=>d[i]);
...
const Decapodes = lazy(() => __vitePreload(() => import('./decapodes-TXhFE0e8.js'),true?__vite__mapDeps([0,1,2,3,4,5,6,7,8]):undefined,import.meta.url));
...
const DiagramGraph = lazy(() => __vitePreload(() => import('./diagram_graph-CF4tgs2w.js'),true?__vite__mapDeps([9,10,1,2,3,6,8,5,11,12,13,14]):undefined,import.meta.url));
...
const TabularView = lazy(() => __vitePreload(() => import('./tabular_view-W0fPiqrE.js'),true?__vite__mapDeps([15,1,2,3,16]):undefined,import.meta.url));
...
const Kuramoto = lazy(() => __vitePreload(() => import('./kuramoto-DDe-gt4g.js'),true?__vite__mapDeps([17,1,2,3,6,7,18,8,5,19]):undefined,import.meta.url));
...
const LinearODE = lazy(() => __vitePreload(() => import('./linear_ode-BQ8pzE74.js'),true?__vite__mapDeps([20,1,2,3,6,7,18,8,5,19]):undefined,import.meta.url));
...
const LotkaVolterra = lazy(() => __vitePreload(() => import('./lotka_volterra-X9LuAZEa.js'),true?__vite__mapDeps([21,1,2,3,6,7,18,8,5,19]):undefined,import.meta.url));
...
const MassAction = lazy(() => __vitePreload(() => import('./mass_action-C5_72pRF.js'),true?__vite__mapDeps([22,1,2,3,6,7,23,18,8,5,24,19]):undefined,import.meta.url));
...
const MassActionEquationsDisplay = lazy(() => __vitePreload(() => import('./mass_action_equations-CT7V0OaP.js'),true?__vite__mapDeps([25,1,2,3,6,23,24,19]):undefined,import.meta.url));
...
const StochasticMassAction = lazy(() => __vitePreload(() => import('./stochastic_mass_action-8nYBsFsu.js'),true?__vite__mapDeps([26,4,1,2,3,6,7,18,8,5,19]):undefined,import.meta.url));
...
const ModelGraph = lazy(() => __vitePreload(() => import('./model_graph-CYxNfIrL.js'),true?__vite__mapDeps([27,10,1,2,3,6,8,5,11,12,13,14]):undefined,import.meta.url));
const schemaERD = (options) => ({
  ...options,
  component: (props) => createComponent(SchemaERD, props),
  initialContent: defaultSchemaERDConfig
});
const SchemaERD = lazy(() => __vitePreload(() => import('./schema_erd-D79g4A5V.js'),true?__vite__mapDeps([28,29,1,2,3,12,6,8,5,13]):undefined,import.meta.url));
...
const SubmodelGraphs = lazy(() => __vitePreload(() => import('./submodel_graphs-CeCtHOgy.js'),true?__vite__mapDeps([30,1,2,3,6,8,5,13,10,11,12,14,27]):undefined,import.meta.url));
const petriNetVisualization = (options) => ({
  ...options,
  component: PetriNetVisualization,
  initialContent: defaultConfig
});
const PetriNetVisualization = lazy(() => __vitePreload(() => import('./petri_net_visualization-DiVOgP45.js'),true?__vite__mapDeps([31,1,2,3,10,6,8,5,11,12,13,14,32]):undefined,import.meta.url));
...
const Reachability = lazy(() => __vitePreload(() => import('./reachability-7udr0CoP.js'),true?__vite__mapDeps([33,1,2,3,16]):undefined,import.meta.url));
const stockFlowDiagram = (options) => ({
  ...options,
  component: StockFlowDiagram,
  initialContent: defaultConfig
});
const StockFlowDiagram = lazy(() => __vitePreload(() => import('./stock_flow_diagram-LrwFUjz7.js'),true?__vite__mapDeps([34,1,2,3,11,8,5,12,10,6,13,14,27,32]):undefined,import.meta.url));
...
const SQLSchemaAnalysis = lazy(() => __vitePreload(() => import('./sql-E5VPUVr4.js'),true?__vite__mapDeps([35,29,1,2,3,12,5,6]):undefined,import.meta.url));
...
const PolynomialODEEquationsDisplay = lazy(() => __vitePreload(() => import('./polynomial_ode_equations-DKvcEdmX.js'),true?__vite__mapDeps([36,1,2,3,6,23,19]):undefined,import.meta.url));
...
const PolynomialODESimulation = lazy(() => __vitePreload(() => import('./polynomial_ode_simulation-BwIZvX8d.js'),true?__vite__mapDeps([37,1,2,3,6,7,23,8,5,19]):undefined,import.meta.url));
