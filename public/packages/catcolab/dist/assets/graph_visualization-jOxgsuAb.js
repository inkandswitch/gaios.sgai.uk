const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./main-CmM6wg7q.js","./analysis_tool-Bl31dlnB.js","./model-hspTLkzk.js","./index-CpJyZPkM.js","./export_svg-B2ewjOY2.js","./file-download-CkoOu1s2.js"])))=>i.map(i=>d[i]);
...
import { o as invariant, y as access, q as IconButton } from './analysis_tool-Bl31dlnB.js';
import './pde_plot-BqBKBDFR.js';
import { d as download_default } from './download-DQHL-c2Z.js';
...
async function loadElk() {
  const ELK = (await __vitePreload(async () => { const {default: __vite_default__} = await import('./main-CmM6wg7q.js').then(n => n.m);return { default: __vite_default__ }},true?__vite__mapDeps([0,1,2,3]):undefined,import.meta.url)).default;
  return new ELK();
}
  ...
  const download = async () => {
    if (props.svg) {
      const {
        ...
        downloadSVG
      } = await import('./export_svg-B2ewjOY2.js');return {
        downloadSVG
