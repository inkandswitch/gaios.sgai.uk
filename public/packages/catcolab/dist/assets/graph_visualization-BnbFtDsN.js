const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./main-5ZxrwekT.js","./analysis_tool-uDJCjaik.js","./model-hspTLkzk.js","./index-Hw8dIQCV.js","./export_svg-CZ9OLXDw.js","./file-download-Bg6ADlqS.js"])))=>i.map(i=>d[i]);
...
import { o as invariant, y as access, q as IconButton } from './analysis_tool-uDJCjaik.js';
...
async function loadElk() {
  const ELK = (await __vitePreload(async () => { const {default: __vite_default__} = await import('./main-5ZxrwekT.js').then(n => n.m);return { default: __vite_default__ }},true?__vite__mapDeps([0,1,2,3]):undefined,import.meta.url)).default;
  return new ELK();
}
  ...
  const download = async () => {
    if (props.svg) {
      const {
        ...
        downloadSVG
      } = await import('./export_svg-CZ9OLXDw.js');return {
        downloadSVG
