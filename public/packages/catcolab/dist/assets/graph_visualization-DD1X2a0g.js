const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./main-BC-xpciA.js","./analysis_tool-CbAnz5ie.js","./model-hspTLkzk.js","./index-B65VBQSl.js","./export_svg-DTM2CAX9.js","./file-download-Dcckh3B1.js"])))=>i.map(i=>d[i]);
...
import { o as invariant, y as access, q as IconButton } from './analysis_tool-CbAnz5ie.js';
import './pde_plot-Ddd_bVHz.js';
import { d as download_default } from './download-FHbQm7GT.js';
...
async function loadElk() {
  const ELK = (await __vitePreload(async () => { const {default: __vite_default__} = await import('./main-BC-xpciA.js').then(n => n.m);return { default: __vite_default__ }},true?__vite__mapDeps([0,1,2,3]):undefined,import.meta.url)).default;
  return new ELK();
}
  ...
  const download = async () => {
    if (props.svg) {
      const {
        ...
        downloadSVG
      } = await import('./export_svg-DTM2CAX9.js');return {
        downloadSVG
